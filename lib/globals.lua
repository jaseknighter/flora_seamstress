...
-- for seamstress navigation keys (used as norns encoder equivalents)
ENCODER_KEYVALS = {"ctrl","alt","super"}
...
INITIAL_PLANT_INSTRUCTIONS_1 = 1 --13 
INITIAL_PLANT_INSTRUCTIONS_2 = 2 --13
menu_status = false
-- pages = 0
flora_params = {}
options = {}
